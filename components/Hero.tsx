...
const Hero = () => {
  return (
    <div className="relative px-20 mx-auto hero gap-8 flex lg:flex-nowrap flex-wrap justify-between items-stretch mt-[155px] h-auto pb-[135px]">
      ...
      <div className="flex lg:basis-1/3 basis-full flex-col items-center lg:items-stretch">
        <div className="relative w-fit border-2 border-[--seed] rounded-xl -rotate-6 -translate-x-6">
          <Image
            src={"/IMG_2645 1.png"}
            alt={"fff"}
            width={500}
            height={500}
            className="w-[300px] h-[300px] bg-[--seed] rounded-xl"
          />
          ...
          <div
            className={
              "absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-2 bg-[--seed] py-1 text-[--baseWhite] font-semibold text-sm shadow-md rounded-md text-nowrap w-full text-center object-center font-cursive "
            }
          >
            Founder Friday
          </div>
        </div>
        <div className="relative w-fit border-2 border-[--seed] rounded-xl rotate-12 -translate-y-40 translate-x-40">
          <Image
            src={"/image 1.png"}
            alt={"fff"}
            width={500}
        ...
        <div className="relative w-fit border-2 border-[--seed] rounded-xl rotate-12 -translate-x-40 -translate-y-40 ">
          <Image
            src={"/IMG_2501 3.png"}
            alt={"fff"}
            width={500}
            height={500}
            className="w-[250px] h-[250px] bg-[--seed] rounded-xl"
          />
        ...
        <div className="relative w-fit border-2 border-[--seed] rounded-xl -rotate-12 -translate-y-20">
          <Image
            src={"/Frame 17.png"}
            alt={"fff"}
            width={500}
            height={500}
            className="w-[100px] h-[100px] bg-[--seed] rounded-xl"
          />
